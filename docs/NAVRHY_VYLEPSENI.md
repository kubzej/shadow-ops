...
### 3.1 Urgentní mise (Flash Operations)

Speciální typ mise s ikonou ⚡. Dostupná jen **5 minut**, obtížnost 3–5, reward × 2.0. Generuje se náhodně 1× za 10–15 minut pro regiony s missionTier ≥ 2. Unikátní timer na kartě mise — bliká červeně pod 60 sekund.
